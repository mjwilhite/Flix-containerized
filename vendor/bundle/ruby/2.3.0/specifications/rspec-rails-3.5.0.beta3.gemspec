...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rspec-core>, ["= 3.5.0.beta3"])
      s.add_runtime_dependency(%q<rspec-expectations>, ["= 3.5.0.beta3"])
      s.add_runtime_dependency(%q<rspec-mocks>, ["= 3.5.0.beta3"])
      s.add_runtime_dependency(%q<rspec-support>, ["= 3.5.0.beta3"])
      ...
      s.add_dependency(%q<rspec-core>, ["= 3.5.0.beta3"])
      s.add_dependency(%q<rspec-expectations>, ["= 3.5.0.beta3"])
      s.add_dependency(%q<rspec-mocks>, ["= 3.5.0.beta3"])
      s.add_dependency(%q<rspec-support>, ["= 3.5.0.beta3"])
